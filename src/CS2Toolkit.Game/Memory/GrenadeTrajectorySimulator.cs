...
internal sealed class GrenadeTrajectorySimulator
{
    private readonly GrenadeSimulationOptions _options;

    public GrenadeTrajectorySimulator(GrenadeSimulationOptions options) => _options = options;
        ...
        out Vector3 velocity)
    {
        ...
        var baseSpeed = GameOffsets.GetGrenadeThrowVelocity(weaponId) * 0.9f;
