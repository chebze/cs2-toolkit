...
Record properties: attachment/match flags, `LocalPlayer`, `Players`, `Round`, `Bomb`, `ViewMatrix`, `RecentSounds`, `Grenades`, `Triggerbot`, `Rcs`, `AimHelper`, clairvoyance tips, team alive counts.
