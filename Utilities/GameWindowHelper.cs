...
public static class GameWindowHelper
{
    ...
    public static Rectangle GetTargetBounds()
    {
        return TryGetCs2ClientBounds() ?? GetPrimaryScreenBounds();
    }
    ...
    private static Rectangle? TryGetCs2ClientBounds()
    {
        ...
        return new Rectangle(topLeft.X, topLeft.Y, clientRect.Right - clientRect.Left, clientRect.Bottom - clientRect.Top);
    }
