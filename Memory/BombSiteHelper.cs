...
{
    public static BombSitesInfo TryReadSites(ProcessMemory memory, GameOffsets offsets, nint entityList)
    {
    ...
    public static Vector3 ReadEntityPosition(ProcessMemory memory, GameOffsets offsets, nint entity)
    {
    ...
    public static Vector3? TryResolveSiteCenter(string? site, BombSitesInfo bombSites)
    {
    ...
    private static Vector3 TryReadSceneNodeOrigin(ProcessMemory memory, GameOffsets offsets, nint entity)
    {
